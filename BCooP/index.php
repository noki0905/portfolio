...
<section class="l-section tp-work" id="work">
  <div class="c-wrapper">
    ...
    <div class="tp-work__slider swiper-container">
      <ul class="swiper-wrapper">
        ...
        <li class="tp-work__slide p-workCard swiper-slide u-text-center">
          <h2 class="p-workCard__ttl"><?php the_titlle(); ?></h2>
          <a href="<?php the_permalink(); ?>"><div class="p-workCard__img"><?php the_post_thumbnail('thumbnail'); ?></div></a>
            <?php
              $terms = get_the_terms( 'work_cate' );     
              if ( $terms && ! is_wp_error( $terms ) ) : 
                $work_links = array();
                foreach ( $terms as $term ) {
                  $work_links[] = $term->name;
                }
                $work_cate = join( "/", $work_links );
            ?>
            <p class="p-workCard__cate"><?php echo $work_cate ?></p>
            <?php endif; ?>
    ...
    <div class="u-text-right">
      <a href="" class="c-linkArrow">See All<span class="c-linkArrow__deco"></span></a>
    </div>
  </div><!-- /.c-wrapper -->
</section><!-- /.tp-work -->
  ...
  <div class="c-wrapper">
    ...
    <ul class="p-blog__list">
      ...
      <li class="tp-blog__card p-blogCard">
        ...
        <?php endif; ?>
          <h2 class="p-blogCard__ttl"><?php echo get_the_title(); ?></h2>
        </a>
